...
import com.print.R;
import com.print.activity.view.PwdWithLabelView;
...
import com.print.util.APKUtil;
import com.print.util.LocationUtil;
...
public class LoginActivity extends BaseActivity implements OnClickListener, TextWatcher{
	...
	private int getSecurityCodeCount				= 0;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        this.getIntent().setAction("com.print.login");
