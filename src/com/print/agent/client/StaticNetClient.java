...
public class StaticNetClient {
	...
	public static byte[] getMessageByTransCode(String transferCode){
		...
		} else if (transferCode.equals("800003")){ // 签到
		...
		} else if (transferCode.equals("820002")){ // 签退成功
		...
		} else if (transferCode.equals("200310001")){ // 银行卡余额查询
			receJSON = "{\"field60\":\"0100000900020\",\"field62\":\"\",\"field39\":\"00\",\"field4\":\"1002156D000000010000\",\"field44\":\"\",\"field25\":\"00\",\"field3\":\"300000\",\"field2\":\"6221881000084798123\",\"field42\":\"222451051920001\",\"field23\":\"000\",\"field49\":\"156\",\"fieldMAC\":\"AB1554AF\",\"field41\":\"22200014\",\"fieldTrancode\":\"200310001\",\"fieldMAB\":\"fieldTrancode;messtype;field2;field3;field11;field13;field25;field32;field39;field41;field42;field53\",\"fieldMessage\":\"银行卡余额查询成功\",\"messtype\":\"0210\",\"field53\":\"2610000000000000\",\"field54\":\"1001156C000000010000\",\"field32\":\"11111111\",\"field14\":\"4912\",\"field13\":\"20130114\",\"field12\":\"101936\",\"field38\":\"\",\"field37\":\"234600268267\",\"field11\":\"000016\"}";
		
		} else if (transferCode.equals("200000022")){  // 收款
			receJSON = "{\"field60\":\"2200000900020\",\"field62\":\"\",\"remark\":\"\",\"field39\":\"00\",\"field4\":\""+demo_amount+"\",\"field44\":\"002300\",\"field3\":\"000000\",\"issuerBank\":\"中国银行\",\"field2\":\""+demo_accountNo+"\",\"field42\":\"222451051920001\",\"field49\":\"156\",\"field41\":\"22200014\",\"fieldMAC\":\"96D25810\",\"fieldTrancode\":\"200000022\",\"fieldMAB\":\"fieldTrancode;messtype;field2;field3;field4;field11;field13;field32;field38;field39;field41;field42;field53\",\"fieldMessage\":\"收款成功\",\"messtype\":\"0210\",\"field55\":\"\",\"field53\":\"2610000000000000\",\"field32\":\"11111111\",\"field14\":\"4912\",\"field13\":\""+AppDataCenter.getValue("__YYYYMMDD")+"\",\"field15\":\"0912\",\"field38\":\"\",\"field12\":\""+AppDataCenter.getValue("__HHMMSS")+"\",\"field37\":\"234600268271\",\"field11\":\"000120\"}";
		...
		} else if (transferCode.equals("200200023")){ // 收款撤销
			receJSON = "{\"field60\":\"2300001400020\",\"field63\":\"CUP\",\"field39\":\"00\",\"field4\":\""+demo_amount+"\",\"field44\":\"\",\"field25\":\"00\",\"field3\":\"200000\",\"field2\":\""+demo_accountNo+"\",\"field42\":\"496652141120001\",\"field23\":\"000\",\"field49\":\"156\",\"fieldMAC\":\"52355320\",\"field41\":\"19820469\",\"fieldMAB\":\"fieldTrancode;messtype;field2;field3;field4;field11;field13;field25;field32;field38;field39;field41;field42;field53\",\"fieldTrancode\":\"200200023\",\"fieldMessage\":\"收款撤销成功\",\"messtype\":\"0210\",\"field55\":\"\",\"field53\":\"2610000000000000\",\"field32\":\"\",\"field14\":\"4912\",\"field13\":\""+AppDataCenter.getValue("__YYYYMMDD")+"\",\"field15\":\"\",\"field12\":\""+AppDataCenter.getValue("__HHMMSS")+"\",\"field38\":\"\",\"field11\":\"025638\",\"field37\":\"234300204072\"}";
		
		} else if (transferCode.equals("200001111")){ // 付款
			receJSON = "{\"field60\":\"2200001400020\",\"field62\":\"\",\"field39\":\"00\",\"field4\":\"000000020000\",\"field44\":\"\",\"field25\":\"00\",\"field3\":\"400000\",\"field2\":\""+demo_accountNo+"\",\"field42\":\"496652141120001\",\"field49\":\"156\",\"field7\":\"20121108\",\"field46\":\"\",\"fieldMAC\":\"718FA0E2\",\"field41\":\"19820469\",\"fieldMAB\":\"fieldTrancode;messtype;field2;field3;field4;field7;field11;field13;field25;field32;field33;field39;field41;field42;field102;field103\",\"fieldTrancode\":\"200001111\",\"fieldMessage\":\"转账成功\",\"messtype\":\"0210\",\"field54\":\"\",\"field32\":\"\",\"field13\":\"20121108\",\"field100\":\"0023000\",\"field33\":\"\",\"field15\":\"0912\",\"field12\":\"140515\",\"field11\":\"028104\",\"field37\":\"234300204074\",\"field103\":\"6226852365896326\",\"field102\":\"6229760070100466095\"}";
